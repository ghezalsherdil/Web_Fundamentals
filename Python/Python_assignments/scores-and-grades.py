...
scorList=[]
for i in range(0,10):
    score=(randint(59,101))
    scorList.append(score)
...
def ScoresAndGrades(lst):
    ...
    for index, item in enumerate(lst,):
        if((item >= 60) & (item <= 69)):
            print "Score:", item, "; Your grade is a D"
        elif ((item >=70) & (item <= 79)):
            print "Score:", item, "; Your grade is a C"
        elif ((item >= 80) & (item <= 89)):
            print "Score:", item, ";Your grade is a B"
        elif ((item >= 90) & (item <=100)):
            print "Score:", item, "; Your grade is a A"
print "End of program"
ScoresAndGrades(scorList)
